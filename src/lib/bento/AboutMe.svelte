<div class="AboutMe w-full rounded-3xl py-6 px-8 bg-white min-h-[360px] min-w-[300px]">
  <h2 class="text-xl tracking-justright font-medium font-heading text-blue-700">
    Hello.
  </h2>
